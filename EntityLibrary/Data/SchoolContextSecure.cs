...
{
    public partial class SchoolContextSecure : DbContext
    {
        /// <summary>
        /// Connection string to interact with the database
        /// </summary>
        private static string _connectionString;
        public SchoolContextSecure()
        {
            _connectionString = Helper.GetConnectionStringSecure();
        }

        public SchoolContextSecure(DbContextOptions<SchoolContext> options) : base(options)
        {
        }
